      ...
      <div className="mt-[6%] mb-[6%] flex flex-col items-center justify-center">
        ...
        <div className="flex flex-wrap w-[70vw] justify-center gap-20">
          {products.map((p, index) => (
            ...
            >
              {/* Discount Badge */}
              <div className="absolute top-3 left-3 bg-emerald-600 text-white px-3 py-1 rounded-tr-xl rounded-bl-xl text-xs font-semibold">
                {p.discount}
              </div>
                ...
                <div className="mt-auto flex justify-between items-center">
                  ...
                  {!addedItems[index] ? (
                    <button
                      ...
                      className="text-[#1B69DE] bg-[#E7F6FF] border px-5 py-2 rounded-full font-semibold transition-colors duration-300 hover:bg-[#1B69DE] hover:text-white"
                    >
                      Add to Cart
                    </button>
                  ) : (
                    <button
                      ...
                      className="text-white bg-[#1B69DE] border px-5 py-2 rounded-full font-semibold"
                    >
                      Item added
                    </button>
                  )}
