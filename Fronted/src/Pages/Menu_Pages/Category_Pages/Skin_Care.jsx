        ...
        <div className="flex flex-wrap w-[70vw] justify-center gap-20">
          {products.map((p, index) => (
            <div
              ...
              className="min-w-[260px] max-w-[260px] bg-white rounded-2xl shadow-md hover:shadow-xl 
              transform hover:scale-105 transition-all duration-300 cursor-pointer flex flex-col select-none relative"
            >
              {/* Discount Badge */}
